...
local themes = {
	index = {'Dark', 'Amethyst', 'Ocean', 'Forest', 'Sunset', 'Midnight', 'Rose', 'Cyber', 'Gold', 'Slate'},
	...
	Ocean = {
		['Shadow'] = Color3.fromRGB(11, 26, 43),
		['Background'] = Color3.fromRGB(16, 34, 54),
		['Page'] = Color3.fromRGB(11, 26, 43),
		['Main'] = Color3.fromRGB(43, 157, 242),
		['Text & Icon'] = Color3.fromRGB(240, 248, 255),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(16, 34, 54),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(18, 73, 122),
					['Toggle Value'] = Color3.fromRGB(43, 157, 242),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(24, 42, 62),
					['Toggle Value'] = Color3.fromRGB(28, 75, 112),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(16, 34, 54),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(16, 34, 54),
				['Value Background'] = Color3.fromRGB(11, 26, 43),
				['Value Stroke'] = Color3.fromRGB(240, 248, 255),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(11, 26, 43),
					['Search'] = Color3.fromRGB(21, 40, 61),
					['Item Background'] = Color3.fromRGB(26, 49, 73),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(16, 34, 54),
				['Value Background'] = Color3.fromRGB(11, 26, 43),
				['Value Stroke'] = Color3.fromRGB(240, 248, 255),
				['Slider Bar'] = Color3.fromRGB(18, 73, 122),
				['Slider Bar Value'] = Color3.fromRGB(43, 157, 242),
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(16, 34, 54)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(16, 34, 54))
				},
				['Background Code'] = Color3.fromRGB(24, 56, 84),
				['Background Code Value'] = Color3.fromRGB(18, 42, 64),
				['ScrollingFrame Code'] = Color3.fromRGB(120, 190, 255)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(16, 34, 54),
	...
	Forest = {
		['Shadow'] = Color3.fromRGB(12, 28, 18),
		['Background'] = Color3.fromRGB(18, 40, 25),
		['Page'] = Color3.fromRGB(12, 28, 18),
		['Main'] = Color3.fromRGB(72, 174, 88),
		['Text & Icon'] = Color3.fromRGB(245, 255, 245),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(18, 40, 25),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(28, 74, 42),
					['Toggle Value'] = Color3.fromRGB(72, 174, 88),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(26, 39, 30),
					['Toggle Value'] = Color3.fromRGB(38, 61, 45),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(18, 40, 25),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(18, 40, 25),
				['Value Background'] = Color3.fromRGB(12, 28, 18),
				['Value Stroke'] = Color3.fromRGB(245, 255, 245),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(12, 28, 18),
					['Search'] = Color3.fromRGB(23, 49, 31),
					['Item Background'] = Color3.fromRGB(28, 58, 38),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(18, 40, 25),
				['Value Background'] = Color3.fromRGB(12, 28, 18),
				['Value Stroke'] = Color3.fromRGB(245, 255, 245),
				['Slider Bar'] = Color3.fromRGB(28, 74, 42),
				['Slider Bar Value'] = Color3.fromRGB(72, 174, 88),
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(18, 40, 25)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(18, 40, 25))
				},
				['Background Code'] = Color3.fromRGB(35, 60, 42),
				['Background Code Value'] = Color3.fromRGB(24, 45, 31),
				['ScrollingFrame Code'] = Color3.fromRGB(142, 220, 156)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(18, 40, 25),
				['Click'] = Color3.fromRGB(245, 255, 245)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(18, 40, 25),
				['Value Background'] = Color3.fromRGB(12, 28, 18),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(12, 28, 18),
					['UIStroke'] = Color3.fromRGB(245, 255, 245),
				}
			}
		}
	},
	...
	Sunset = {
		['Shadow'] = Color3.fromRGB(38, 20, 24),
		['Background'] = Color3.fromRGB(56, 29, 34),
		['Page'] = Color3.fromRGB(38, 20, 24),
		['Main'] = Color3.fromRGB(255, 122, 89),
		['Text & Icon'] = Color3.fromRGB(255, 244, 240),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(56, 29, 34),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(124, 49, 57),
					['Toggle Value'] = Color3.fromRGB(255, 122, 89),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(67, 38, 43),
					['Toggle Value'] = Color3.fromRGB(96, 56, 62),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(56, 29, 34),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(56, 29, 34),
				['Value Background'] = Color3.fromRGB(38, 20, 24),
				['Value Stroke'] = Color3.fromRGB(255, 244, 240),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(38, 20, 24),
					['Search'] = Color3.fromRGB(68, 38, 43),
					['Item Background'] = Color3.fromRGB(84, 49, 53),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(56, 29, 34),
				['Value Background'] = Color3.fromRGB(38, 20, 24),
				['Value Stroke'] = Color3.fromRGB(255, 244, 240),
				['Slider Bar'] = Color3.fromRGB(124, 49, 57),
				['Slider Bar Value'] = Color3.fromRGB(255, 122, 89),
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(56, 29, 34)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(56, 29, 34))
				},
				['Background Code'] = Color3.fromRGB(103, 55, 61),
				['Background Code Value'] = Color3.fromRGB(70, 37, 42),
				['ScrollingFrame Code'] = Color3.fromRGB(255, 171, 135)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(56, 29, 34),
				['Click'] = Color3.fromRGB(255, 244, 240)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(56, 29, 34),
				['Value Background'] = Color3.fromRGB(38, 20, 24),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(38, 20, 24),
					['UIStroke'] = Color3.fromRGB(255, 244, 240),
				}
			}
		}
	},
	...
	Midnight = {
		['Shadow'] = Color3.fromRGB(10, 10, 18),
		['Background'] = Color3.fromRGB(16, 16, 28),
		['Page'] = Color3.fromRGB(10, 10, 18),
		['Main'] = Color3.fromRGB(122, 92, 255),
		['Text & Icon'] = Color3.fromRGB(245, 245, 255),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(16, 16, 28),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(43, 39, 90),
					['Toggle Value'] = Color3.fromRGB(122, 92, 255),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(23, 23, 38),
					['Toggle Value'] = Color3.fromRGB(38, 38, 58),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(16, 16, 28),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(16, 16, 28),
				['Value Background'] = Color3.fromRGB(10, 10, 18),
				['Value Stroke'] = Color3.fromRGB(245, 245, 255),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(10, 10, 18),
					['Search'] = Color3.fromRGB(24, 24, 40),
					['Item Background'] = Color3.fromRGB(34, 34, 52),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(16, 16, 28),
				['Value Background'] = Color3.fromRGB(10, 10, 18),
				['Value Stroke'] = Color3.fromRGB(245, 245, 255),
				['Slider Bar'] = Color3.fromRGB(43, 39, 90),
				['Slider Bar Value'] = Color3.fromRGB(122, 92, 255),
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(16, 16, 28)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(16, 16, 28))
				},
				['Background Code'] = Color3.fromRGB(33, 33, 54),
				['Background Code Value'] = Color3.fromRGB(24, 24, 40),
				['ScrollingFrame Code'] = Color3.fromRGB(168, 149, 255)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(16, 16, 28),
	...
	Rose = {
		['Shadow'] = Color3.fromRGB(34, 17, 25),
		['Background'] = Color3.fromRGB(52, 28, 38),
		['Page'] = Color3.fromRGB(34, 17, 25),
		['Main'] = Color3.fromRGB(255, 110, 151),
		['Text & Icon'] = Color3.fromRGB(255, 245, 248),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(52, 28, 38),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(115, 43, 70),
					['Toggle Value'] = Color3.fromRGB(255, 110, 151),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(67, 39, 50),
					['Toggle Value'] = Color3.fromRGB(94, 52, 65),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(52, 28, 38),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(52, 28, 38),
				['Value Background'] = Color3.fromRGB(34, 17, 25),
				['Value Stroke'] = Color3.fromRGB(255, 245, 248),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(34, 17, 25),
					['Search'] = Color3.fromRGB(61, 34, 44),
					['Item Background'] = Color3.fromRGB(83, 48, 61),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(52, 28, 38),
				['Value Background'] = Color3.fromRGB(34, 17, 25),
				['Value Stroke'] = Color3.fromRGB(255, 245, 248),
				['Slider Bar'] = Color3.fromRGB(115, 43, 70),
				['Slider Bar Value'] = Color3.fromRGB(255, 110, 151),
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(52, 28, 38)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(52, 28, 38))
				},
				['Background Code'] = Color3.fromRGB(92, 52, 68),
				['Background Code Value'] = Color3.fromRGB(65, 36, 47),
				['ScrollingFrame Code'] = Color3.fromRGB(255, 164, 192)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(52, 28, 38),
				['Click'] = Color3.fromRGB(255, 245, 248)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(52, 28, 38),
				['Value Background'] = Color3.fromRGB(34, 17, 25),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(34, 17, 25),
					['UIStroke'] = Color3.fromRGB(255, 245, 248),
				}
			}
		}
	},
	...
	Cyber = {
		['Shadow'] = Color3.fromRGB(11, 16, 21),
		['Background'] = Color3.fromRGB(16, 23, 31),
		['Page'] = Color3.fromRGB(11, 16, 21),
		['Main'] = Color3.fromRGB(0, 229, 255),
		['Text & Icon'] = Color3.fromRGB(240, 255, 255),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(16, 23, 31),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(0, 105, 120),
					['Toggle Value'] = Color3.fromRGB(0, 229, 255),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(24, 31, 40),
					['Toggle Value'] = Color3.fromRGB(32, 58, 66),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(16, 23, 31),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(16, 23, 31),
				['Value Background'] = Color3.fromRGB(11, 16, 21),
				['Value Stroke'] = Color3.fromRGB(240, 255, 255),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(11, 16, 21),
					['Search'] = Color3.fromRGB(21, 30, 39),
					['Item Background'] = Color3.fromRGB(28, 42, 54),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(16, 23, 31),
				['Value Background'] = Color3.fromRGB(11, 16, 21),
				['Value Stroke'] = Color3.fromRGB(240, 255, 255),
				['Slider Bar'] = Color3.fromRGB(0, 105, 120),
				['Slider Bar Value'] = Color3.fromRGB(0, 229, 255),
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(16, 23, 31)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(16, 23, 31))
				},
				['Background Code'] = Color3.fromRGB(26, 36, 47),
				['Background Code Value'] = Color3.fromRGB(18, 27, 35),
				['ScrollingFrame Code'] = Color3.fromRGB(0, 229, 255)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(16, 23, 31),
				['Click'] = Color3.fromRGB(240, 255, 255)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(16, 23, 31),
				['Value Background'] = Color3.fromRGB(11, 16, 21),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(11, 16, 21),
					['UIStroke'] = Color3.fromRGB(240, 255, 255),
				}
			}
		}
	},
	...
	Gold = {
		['Shadow'] = Color3.fromRGB(35, 26, 10),
		['Background'] = Color3.fromRGB(54, 42, 17),
		['Page'] = Color3.fromRGB(35, 26, 10),
		['Main'] = Color3.fromRGB(255, 196, 64),
		['Text & Icon'] = Color3.fromRGB(255, 248, 228),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(54, 42, 17),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(121, 90, 21),
					['Toggle Value'] = Color3.fromRGB(255, 196, 64),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(68, 52, 25),
					['Toggle Value'] = Color3.fromRGB(100, 78, 33),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(54, 42, 17),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(54, 42, 17),
				['Value Background'] = Color3.fromRGB(35, 26, 10),
				['Value Stroke'] = Color3.fromRGB(255, 248, 228),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(35, 26, 10),
					['Search'] = Color3.fromRGB(66, 53, 23),
					['Item Background'] = Color3.fromRGB(87, 69, 29),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(54, 42, 17),
				['Value Background'] = Color3.fromRGB(35, 26, 10),
				['Value Stroke'] = Color3.fromRGB(255, 248, 228),
				['Slider Bar'] = Color3.fromRGB(121, 90, 21),
				['Slider Bar Value'] = Color3.fromRGB(255, 196, 64),
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(54, 42, 17)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(54, 42, 17))
				},
				['Background Code'] = Color3.fromRGB(101, 79, 33),
				['Background Code Value'] = Color3.fromRGB(66, 51, 21),
				['ScrollingFrame Code'] = Color3.fromRGB(255, 216, 110)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(54, 42, 17),
				['Click'] = Color3.fromRGB(255, 248, 228)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(54, 42, 17),
				['Value Background'] = Color3.fromRGB(35, 26, 10),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(35, 26, 10),
					['UIStroke'] = Color3.fromRGB(255, 248, 228),
				}
			}
		}
	},
	...
	Slate = {
		['Shadow'] = Color3.fromRGB(19, 22, 27),
		['Background'] = Color3.fromRGB(30, 34, 40),
		['Page'] = Color3.fromRGB(19, 22, 27),
		['Main'] = Color3.fromRGB(119, 132, 153),
		['Text & Icon'] = Color3.fromRGB(245, 247, 250),
		['Function'] = {
			['Toggle'] = {
				['Background'] = Color3.fromRGB(30, 34, 40),
				['True'] = {
					['Toggle Background'] = Color3.fromRGB(58, 67, 79),
					['Toggle Value'] = Color3.fromRGB(119, 132, 153),
				},
				['False'] = {
					['Toggle Background'] = Color3.fromRGB(37, 41, 47),
					['Toggle Value'] = Color3.fromRGB(55, 61, 70),
				}
			},
			['Label'] = {
				['Background'] = Color3.fromRGB(30, 34, 40),
			...
			['Dropdown'] = {
				['Background'] = Color3.fromRGB(30, 34, 40),
				['Value Background'] = Color3.fromRGB(19, 22, 27),
				['Value Stroke'] = Color3.fromRGB(245, 247, 250),
				['Dropdown Select'] = {
					['Background'] = Color3.fromRGB(19, 22, 27),
					['Search'] = Color3.fromRGB(39, 44, 52),
					['Item Background'] = Color3.fromRGB(48, 54, 63),
				}
			},
			['Slider'] = {
				['Background'] = Color3.fromRGB(30, 34, 40),
				['Value Background'] = Color3.fromRGB(19, 22, 27),
				['Value Stroke'] = Color3.fromRGB(245, 247, 250),
				['Slider Bar'] = Color3.fromRGB(58, 67, 79),
				['Slider Bar Value'] = Color3.fromRGB(119, 132, 153),
				['Circle Value'] = Color3.fromRGB(255, 255, 255)
			},
			['Code'] = {
				['Background'] = ColorSequence.new{
					ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 34, 40)),
					ColorSequenceKeypoint.new(1, Color3.fromRGB(30, 34, 40))
				},
				['Background Code'] = Color3.fromRGB(44, 50, 59),
				['Background Code Value'] = Color3.fromRGB(28, 32, 38),
				['ScrollingFrame Code'] = Color3.fromRGB(175, 186, 202)
			},
			['Button'] = {
				['Background'] = Color3.fromRGB(30, 34, 40),
				['Click'] = Color3.fromRGB(245, 247, 250)
			},
			['Textbox'] = {
				['Background'] = Color3.fromRGB(30, 34, 40),
				['Value Background'] = Color3.fromRGB(19, 22, 27),
			...
			['Color Picker'] = {
				...
				['Color Select'] = {
					['Background'] = Color3.fromRGB(19, 22, 27),
					['UIStroke'] = Color3.fromRGB(245, 247, 250),
				}
			}
		}
	}
...
do
	...
	local IconList = loadstring(game:HttpGet('https://raw.githubusercontent.com/Altis-DEV/DummyUiLibrary/refs/heads/main/icon.lua'))()
	function gl(i)
...
function Library:Window(p)
	...
	function Tabs:Tab(p)
		...
		function Func:Label(p)
			...
			function Func:Paragraph(p)
				local TitleText = p.Title or 'Title'
				local BodyText  = p.Text  or ''
				...
				RealBackground.BackgroundTransparency = 1
				RealBackground.BorderSizePixel = 0
				RealBackground.Size = UDim2.new(1, 0, 0, 0)
				RealBackground.AutomaticSize = Enum.AutomaticSize.Y
				RealBackground.ClipsDescendants = false

				local Card = Instance.new("Frame")
				Card.Name = "Background"
				Card.Parent = RealBackground
				Card.BackgroundColor3 = Color3.fromRGB(29, 28, 38)
				...
				addToTheme('Function.Label.Background', Card)
				...
				TitleFrame.BackgroundColor3 = Color3.fromRGB(24, 24, 31)
				...
				TitleCover.BackgroundColor3 = Color3.fromRGB(24, 24, 31)
				TitleCover.BorderSizePixel = 0
				TitleCover.AnchorPoint = Vector2.new(0, 1)
				TitleCover.Position = UDim2.new(0, 0, 1, 0)
				TitleCover.Size = UDim2.new(1, 0, 0, 6)
				addToTheme('Page', TitleFrame)
				addToTheme('Page', TitleCover)

				local TitleInner = Instance.new("Frame")
				TitleInner.Parent = TitleFrame
				TitleInner.BackgroundTransparency = 1
				TitleInner.Size = UDim2.new(1, 0, 0, 0)
				TitleInner.AutomaticSize = Enum.AutomaticSize.Y
				local TitleInnerLayout = Instance.new("UIListLayout")
				TitleInnerLayout.Parent = TitleInner
				TitleInnerLayout.FillDirection = Enum.FillDirection.Horizontal
				TitleInnerLayout.VerticalAlignment = Enum.VerticalAlignment.Center
				TitleInnerLayout.Padding = UDim.new(0, 6)
				TitleInnerLayout.SortOrder = Enum.SortOrder.LayoutOrder
				local TitleInnerPad = Instance.new("UIPadding")
				TitleInnerPad.Parent = TitleInner
				TitleInnerPad.PaddingLeft   = UDim.new(0, 10)
				TitleInnerPad.PaddingRight  = UDim.new(0, 10)
				TitleInnerPad.PaddingTop    = UDim.new(0, 7)
				TitleInnerPad.PaddingBottom = UDim.new(0, 7)

				if Icon and Icon ~= '' then
					local TitleIcon = Instance.new("ImageLabel")
					TitleIcon.Parent = TitleInner
					TitleIcon.BackgroundTransparency = 1
					TitleIcon.Size = UDim2.new(0, 14, 0, 14)
					TitleIcon.Image = gl(Icon).Image
					TitleIcon.ImageRectSize = gl(Icon).ImageRectSize
					TitleIcon.ImageRectOffset = gl(Icon).ImageRectPosition
					TitleIcon.ImageTransparency = 0.3
					TitleIcon.LayoutOrder = 0
					addToTheme('Text & Icon', TitleIcon)
				end

				local TitleLbl = Instance.new("TextLabel")
				TitleLbl.Name = "ParagraphTitle"
				TitleLbl.Parent = TitleInner
				TitleLbl.BackgroundTransparency = 1
				TitleLbl.Size = UDim2.new(1, 0, 0, 0)
				TitleLbl.AutomaticSize = Enum.AutomaticSize.Y
				TitleLbl.Font = Enum.Font.GothamBold
				TitleLbl.RichText = true
				TitleLbl.Text = tostring(TitleText)
				TitleLbl.TextColor3 = Color3.fromRGB(255, 255, 255)
				TitleLbl.TextSize = 12
				TitleLbl.TextWrapped = true
				TitleLbl.TextXAlignment = Enum.TextXAlignment.Left
				TitleLbl.LayoutOrder = 1
				addToTheme('Text & Icon', TitleLbl)

				-- BODY FRAME
				local BodyFrame = Instance.new("Frame")
				BodyFrame.Name = "BodyFrame"
				BodyFrame.Parent = Card
				BodyFrame.BackgroundColor3 = Color3.fromRGB(29, 28, 38)
				...
				BodyCover.Parent = BodyFrame
				BodyCover.BackgroundColor3 = Color3.fromRGB(29, 28, 38)
				BodyCover.BorderSizePixel = 0
				BodyCover.Size = UDim2.new(1, 0, 0, 6)
				addToTheme('Function.Label.Background', BodyFrame)
				addToTheme('Function.Label.Background', BodyCover)
				...
				BodyLbl.Name = "ParagraphText"
				BodyLbl.Parent = BodyFrame
				BodyLbl.BackgroundTransparency = 1
				BodyLbl.Size = UDim2.new(1, 0, 0, 0)
				BodyLbl.AutomaticSize = Enum.AutomaticSize.Y
				BodyLbl.Font = Enum.Font.Gotham
				BodyLbl.RichText = true
				BodyLbl.Text = tostring(BodyText)
				BodyLbl.TextColor3 = Color3.fromRGB(200, 198, 220)
				BodyLbl.TextSize = 11
				BodyLbl.TextTransparency = 0.2
				BodyLbl.TextWrapped = true
				BodyLbl.TextXAlignment = Enum.TextXAlignment.Left
				addToTheme('Text & Icon', BodyLbl)

				local New = {}
				function New:SetTitle(t) TitleLbl.Text = tostring(t) end
				function New:SetText(t)  BodyLbl.Text  = tostring(t) end
				function New:SetVisible(t) RealBackground.Visible = t end
				return New
			end
		...
		function Func:ColorPicker(p)
			...
			-- PC: close when clicking outside
			U.InputBegan:Connect(function(A)
				if A.UserInputType == Enum.UserInputType.MouseButton1 and isopen then
					local B, C = ColorpickBar.AbsolutePosition, ColorpickBar.AbsoluteSize
					local px, py = A.Position.X, A.Position.Y
					if px < B.X or px > B.X + C.X or py < (B.Y - 21) or py > B.Y + C.Y then
						close()
					end
				end
			end)
			...
			-- ── COLORPICKER DRAG (PC + Mobile unified via input.Position)
			local colorDragging = false
			local hueDragging   = false
			local activeColorInput = nil  -- track active touch input for color
			local activeHueInput   = nil  -- track active touch input for hue

			local function applyColorPos(posX, posY)
				local ax = Color_1.AbsolutePosition.X
				local ay = Color_1.AbsolutePosition.Y
				local aw = Color_1.AbsoluteSize.X
				local ah = Color_1.AbsoluteSize.Y
				if aw == 0 or ah == 0 then return end
				local cx = math.clamp((posX - ax) / aw, 0, 1)
				local cy = math.clamp((posY - ay) / ah, 0, 1)
				tw({v = ColorSelection_1, t = 0.08, s = Enum.EasingStyle.Linear, d = "Out",
					g = {Position = UDim2.new(cx, 0, cy, 0)}}):Play()
				ColorS = cx
				ColorV = 1 - cy
				UpdateColorPicker(true)
			end

			local function applyHuePos(posY)
				local ay = Hue_1.AbsolutePosition.Y
				local ah = Hue_1.AbsoluteSize.Y
				if ah == 0 then return end
				local hy = math.clamp((posY - ay) / ah, 0, 1)
				tw({v = HueSelection_1, t = 0.08, s = Enum.EasingStyle.Linear, d = "Out",
					g = {Position = UDim2.new(0.5, 0, hy, 0)}}):Play()
				ColorH = 1 - hy
				UpdateColorPicker(true)
			end

			-- Color panel — begin drag
			Color_1.InputBegan:Connect(function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1
				or input.UserInputType == Enum.UserInputType.Touch then
					colorDragging = true
					activeColorInput = input
					applyColorPos(input.Position.X, input.Position.Y)
				end
			end)

			-- Hue strip — begin drag
			Hue_1.InputBegan:Connect(function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1
				or input.UserInputType == Enum.UserInputType.Touch then
					hueDragging = true
					activeHueInput = input
					applyHuePos(input.Position.Y)
				end
			end)

			-- Global InputChanged — handles both mouse move and touch move
			U.InputChanged:Connect(function(input)
				if colorDragging then
					if input.UserInputType == Enum.UserInputType.MouseMovement
					or (input.UserInputType == Enum.UserInputType.Touch
						and activeColorInput and input == activeColorInput) then
						applyColorPos(input.Position.X, input.Position.Y)
					end
				end
				if hueDragging then
					if input.UserInputType == Enum.UserInputType.MouseMovement
					or (input.UserInputType == Enum.UserInputType.Touch
						and activeHueInput and input == activeHueInput) then
						applyHuePos(input.Position.Y)
					end
				end
			end)
			...
			U.InputEnded:Connect(function(input)
				...
				elseif input.UserInputType == Enum.UserInputType.Touch then
					if input == activeColorInput then
						colorDragging  = false
						activeColorInput = nil
					end
					if input == activeHueInput then
						hueDragging    = false
						activeHueInput = nil
					end
				end
			...
			-- Also close picker when tapping outside on mobile (touch)
			U.InputBegan:Connect(function(input)
				if input.UserInputType == Enum.UserInputType.Touch and isopen then
					-- small delay so a tap on the picker itself doesn't immediately close
					task.defer(function()
						local B = ColorpickBar.AbsolutePosition
						local C = ColorpickBar.AbsoluteSize
						local px, py = input.Position.X, input.Position.Y
						if px < B.X or px > B.X + C.X or py < B.Y - 20 or py > B.Y + C.Y then
							close()
						end
					end)
				end
		...
		function Func:Image(p)
			-- p.Image: number (assetid), "rbxassetid://...", or raw https url (.jpg/.png)
			-- p.Ratio: optional aspect ratio (default 1 = square)
			local src = p and p.Image or ''
			local ratio = (p and p.Ratio) or 1

			-- Resolve image source
			local function resolveImage(rawSrc)
				if type(rawSrc) == 'number' then
					return 'rbxassetid://' .. tostring(rawSrc)
				end
				local s = tostring(rawSrc)
				if s:match('^rbxassetid://') then
					return s
				end
				-- raw https URL — try getcustomasset
				if s:match('^https?://') then
					if getcustomasset and writefile and isfile and makefolder then
						local ok2, result = pcall(function()
							if not isfolder('DummyUICache') then makefolder('DummyUICache') end
							local hash = 0
							for i = 1, #s do hash = (hash + string.byte(s, i)) % 9999999 end
							local ext = s:match('%.png') and '.png' or '.jpg'
							local path = 'DummyUICache/' .. hash .. ext
					...
					-- fallback: try direct (works in Studio / some executors)
					return s
				end
				return ''
			end

			-- Outer wrapper that sits in the scroll list
			local RealBackground = Instance.new("Frame")
			RealBackground.Name = "Real Background"
			RealBackground.Parent = ScrollingFrame_1
			RealBackground.BackgroundTransparency = 1
			RealBackground.BorderColor3 = Color3.fromRGB(0,0,0)
			RealBackground.BorderSizePixel = 0
			-- Height = width * (1/ratio), but we use SizeConstraint trick:
			-- We want height == absolute width. Use a square via AbsoluteSize watcher.
			RealBackground.Size = UDim2.new(1, 0, 0, 200) -- placeholder; updated below
			RealBackground.ClipsDescendants = false

			-- Container frame that clips
			local Container = Instance.new("Frame")
			Container.Name = "ImageContainer"
			Container.Parent = RealBackground
			Container.BackgroundColor3 = Color3.fromRGB(24, 24, 31)
			Container.BorderSizePixel = 0
			Container.Size = UDim2.new(1, 0, 1, 0)
			Container.ClipsDescendants = true
			local UICorner_img = Instance.new("UICorner")
			UICorner_img.CornerRadius = UDim.new(0, 6)
			UICorner_img.Parent = Container

			-- The image label
			local ImageLogo = Instance.new("ImageLabel")
			ImageLogo.Name = "Im"
			ImageLogo.Parent = Container
			ImageLogo.BackgroundTransparency = 1
			ImageLogo.Size = UDim2.new(1, 0, 1, 0)
			ImageLogo.ScaleType = Enum.ScaleType.Fit
			ImageLogo.Active = false
			ImageLogo.Image = ''

			-- Loading label
			local LoadLbl = Instance.new("TextLabel")
			LoadLbl.Parent = Container
			LoadLbl.Size = UDim2.new(1, 0, 1, 0)
			LoadLbl.BackgroundTransparency = 1
			LoadLbl.Text = "⏳ Loading..."
			LoadLbl.Font = Enum.Font.Gotham
			LoadLbl.TextSize = 11
			LoadLbl.TextColor3 = Color3.fromRGB(150, 148, 180)
			LoadLbl.ZIndex = 2

			-- Update RealBackground height so it is always a square (width × 1/ratio)
			local function updateHeight()
				task.defer(function()
					local w = RealBackground.AbsoluteSize.X
					local h = math.max(40, math.floor(w / math.max(ratio, 0.1)))
					if math.abs(RealBackground.Size.Y.Offset - h) > 1 then
						RealBackground.Size = UDim2.new(1, 0, 0, h)
					end
				end)
			end

			RealBackground:GetPropertyChangedSignal("AbsoluteSize"):Connect(updateHeight)
			updateHeight()

			-- Async load
			task.spawn(function()
				local resolved = resolveImage(src)
				if resolved and resolved ~= '' then
					ImageLogo.Image = resolved
					LoadLbl.Text = ''
				else
					LoadLbl.Text = "⚠️ Cannot load image"
					LoadLbl.TextColor3 = Color3.fromRGB(255, 100, 100)
				end
			end)

			local New = {}
			function New:SetImage(newSrc)
				src = newSrc
				LoadLbl.Text = "⏳ Loading..."
				LoadLbl.TextColor3 = Color3.fromRGB(150, 148, 180)
				task.spawn(function()
					local resolved = resolveImage(newSrc)
					if resolved and resolved ~= '' then
						ImageLogo.Image = resolved
						LoadLbl.Text = ''
					else
	...
	function Tabs:Dialog(p)
		if Shadow_1:FindFirstChild('Dialog') then return end

		local Button1Cb   = p.Button1 and (p.Button1.Callback or function() end) or function() end
		local Button2Cb   = p.Button2 and (p.Button2.Callback or function() end) or function() end
		local Title       = p.Title or 'null'
		local TitleBtn1   = p.Button1 and (p.Button1.Title or 'Confirm') or 'Confirm'
		local TitleBtn2   = p.Button2 and (p.Button2.Title or 'Cancel')  or 'Cancel'
		local Color1      = p.Button1 and (p.Button1.Color or Color3.fromRGB(91, 68, 209)) or Color3.fromRGB(91, 68, 209)
		local Color2      = p.Button2 and (p.Button2.Color or Color3.fromRGB(55, 55, 72))  or Color3.fromRGB(55, 55, 72)
		local curTheme    = themes[IsTheme]
		...
		Dialog.BackgroundTransparency = 0.45
		Dialog.BorderSizePixel = 0
		Dialog.Size = UDim2.new(1, 0, 1, 0)
		Dialog.GroupTransparency = 1
		local UICorner_dlg = Instance.new("UICorner")
		UICorner_dlg.CornerRadius = UDim.new(0, 17)
		UICorner_dlg.Parent = Dialog
		...
		Card.BackgroundColor3 = curTheme.Background
		Card.BorderSizePixel = 0
		...
		UIStroke_card.Color = curTheme['Text & Icon']
		UIStroke_card.Thickness = 1
		UIStroke_card.Transparency = 0.88
		...
		TitleLbl.TextColor3 = curTheme['Text & Icon']
		...
		Sep.Parent = Card
		Sep.BackgroundColor3 = curTheme['Text & Icon']
		Sep.BackgroundTransparency = 0.88
		Sep.BorderSizePixel = 0
		Sep.Size = UDim2.new(1, 0, 0, 1)
		Sep.LayoutOrder = 1
		addToTheme('Text & Icon', Sep)
		...
		local function makeDialogBtn(parent, label, bgColor, order)
			...
			Btn.MouseEnter:Connect(function()
				Tw:Create(Btn, TweenInfo.new(0.12, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
		...
		local Btn1 = makeDialogBtn(BtnRow, TitleBtn1, Color1, 1)
		local Btn2 = makeDialogBtn(BtnRow, TitleBtn2, Color2, 2)

		-- Auto-resize card based on title height
		local function resizeCard()
			task.defer(function()
				local titleH = TitleLbl.AbsoluteSize.Y
				local totalH = 14 + titleH + 1 + 8 + 32 + 12
				Card.Size = UDim2.new(0, 240, 0, math.max(totalH, 110))
			end)
		end
		TitleLbl:GetPropertyChangedSignal("AbsoluteSize"):Connect(resizeCard)
		task.delay(0.05, resizeCard)

		-- Animate in
		tw({v = Dialog, t = 0.2, s = Enum.EasingStyle.Linear, d = "Out", g = {GroupTransparency = 0}}):Play()

		local function dismissDialog()
			local f = tw({v = Dialog, t = 0.18, s = Enum.EasingStyle.Linear, d = "Out", g = {GroupTransparency = 1}})
			f:Play()
			f.Completed:Wait()
			Dialog:Destroy()
		end
		...
		Btn1.MouseButton1Click:Connect(function()
			jcf(Card, Btn1)
			tw({v = Btn1, t = 0.1, s = Enum.EasingStyle.Back, d = "Out", g = {Size = UDim2.new(0, 93, 0, 27)}}):Play()
			delay(0.1, function() Btn1.Size = UDim2.new(0, 100, 0, 30) end)
			pcall(Button1Cb)
			dismissDialog()
		end)
		...
		Btn2.MouseButton1Click:Connect(function()
			jcf(Card, Btn2)
			tw({v = Btn2, t = 0.1, s = Enum.EasingStyle.Back, d = "Out", g = {Size = UDim2.new(0, 93, 0, 27)}}):Play()
			delay(0.1, function() Btn2.Size = UDim2.new(0, 100, 0, 30) end)
			pcall(Button2Cb)
			dismissDialog()
		end)
	end
